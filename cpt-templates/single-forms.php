...
echo "<section role='main' id='content' class='wpss-content wpss-container-content col col-10'>";

do_action( 'wpss_before_content' );
...
if ( have_posts() ):
	...
	while ( have_posts() ): the_post();
		...
		if ( ! is_home() && ! is_front_page() ):
			echo '<h3 aria-labelledby="wpss-article">' . get_the_title() . '</h3>';
		endif;
		...
		echo "</div>";
		echo "<div class='col-md-3 wpss-right-sidebar'>";
